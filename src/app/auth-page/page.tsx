...
import { Mail, Lock, Eye, EyeOff, BookOpen, GraduationCap, ArrowRight, User } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        if (data.token) {
            ...
            if (!isLogin) {
                // If it's a sign-up, navigate to the login page
                setIsLogin(true);
                setFormData({ name: "", email: "", password: "" });
                setErrors({});
                router.push('/auth-page'); // Explicitly navigate to the login page
