...
const AboutSection = () => {
    ...
    return (
        <section className="bg-secondary-green py-16 relative overflow-hidden">
            ...
            <div
                ...
                >
                    ...
                    <div className="flex justify-center lg:justify-start space-x-8 mb-8">
                        <motion.button
                            className="bg-green-shade text-white px-6 py-3 rounded-lg shadow-lg hover:bg-green-700 transition"
