...
interface ApContactDisplayProps {
    data?: ApContactData[];
    isLoading?: boolean;
}

const ApContactDisplay: React.FC<ApContactDisplayProps> = ({ data = [], isLoading = false }) => {
    const [searchTerm, setSearchTerm] = useState("");
    const [filterType, setFilterType] = useState<"name" | "phone" | "location">("name");
        ...
        <div className="flex-1 w-full min-h-screen bg-secondary-green">
            <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                    <h1 className="text-2xl font-bold text-gray-800 mb-2">ApContact Forms</h1>
                    <p className="text-gray-600 text-sm">
                        Showing {paginatedData.length} of {filteredData.length} contact forms
                    </p>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    type={filterType === "location" ? "text" : "text"}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                onChange={(e) => setFilterType(e.target.value as "name" | "phone" | "location")}
                                value={filterType}
                            >
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {paginatedData.map((item) => (
                                        <tr key={item._id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-gray-600">{item.message || "N/A"}</td>
                                            <td className="px-6 py-4 text-gray-600">
...
export default ApContactDisplay;
