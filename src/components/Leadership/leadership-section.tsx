        ...
        <div className="bg-secondary-green2 min-h-screen p-16">
            <div className="container mx-auto px-6 lg:px-12">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-green-sjade mb-4">Merit Leadership Program</h1>
                ...
                <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div>
                        <h2 className="text-2xl font-semibold text-green-shade mb-4">Toastmasters International</h2>
                        <p className="text-green-800 leading-7 mb-6">
                ...
                <div className="bg-secondary-green2 rounded-lg p-8">
                    ...
                    <p className="text-green-800 leading-7 text-center mb-6">
